...
// Each section has its own positional audio source (sound plays from mesh position)
...
function init() {
	...
	meshes.standard2 = addStandardMeshes()
	meshes.standard3 = addStandardMeshes()
...
function animate() {
	...
	// Map scroll progress to camera Y position (scroll down → camera moves down in 3D)
	camera.position.y = (-scrollY / window.innerHeight) * objectDistance
	// Listener is attached to camera, so 3D audio position updates automatically as camera moves
